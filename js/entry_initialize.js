...
const child1Msg2= document.getElementById('child1-msg2');
const child1Msg3= document.getElementById('child1-msg3');
const child2Msg = document.getElementById('child2-msg');
const child2Msg2= document.getElementById('child2-msg2');
const child2Msg3= document.getElementById('child2-msg3');
const child3Msg = document.getElementById('child3-msg');
const child3Msg2= document.getElementById('child3-msg2');
const child3Msg3= document.getElementById('child3-msg3');
const parentMsg = document.getElementById('parent-msg');
const parentMsg2= document.getElementById('parent-msg2');
